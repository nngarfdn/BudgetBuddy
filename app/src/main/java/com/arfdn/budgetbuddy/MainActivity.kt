...
import com.arfdn.budgetbuddy.databinding.ActivityMainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with(binding) {
            ...
            btnUpdate.setOnClickListener {
                ...
                val description = edtDesc.text.toString()
                val date = edtDate.text.toString()
                val budgetToUpdate = Budget(nominal = nominal, description = description, date = date)
